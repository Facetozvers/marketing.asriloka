                            ...
                            <tr>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item {{$listing->Approval === 'Pending' ? 'disabled' : ''}}" {{$listing->Approval != 'Pending' ? 'href=https://asriloka.com/properti/'.$listing->id_properti.'?token='.Auth::user()->token : ''}}>Kunjungi Laman Sebagai Marketing</a>
